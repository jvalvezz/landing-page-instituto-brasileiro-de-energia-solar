      ...
      <main className="overflow-hidden">
        ...
        <section id="parceiros" className="section">
          ...
          <div className="mx-auto max-w-4xl space-y-6 text-center">
            ...
            >
              ...
              Possibilidade de redução em até 20% na conta de luz com governãnça, serviços compartilhados e tecnologia para acelerar a jornada dos cooperados.
          ...
          <div className="mt-12 grid gap-10 md:grid-cols-[1.1fr_0.9fr] md:items-center">
            ...
            <motion.div
              ...
              className="space-y-4 text-left text-lg text-slate-600"
              ...
              <div className="flex flex-wrap items-center gap-4 pt-2">
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <select
                    ...
                    className="w-full rounded-2xl border border-brand-primary/40 bg-white px-4 py-3 text-sm font-semibold text-brand-dark shadow-soft transition hover:border-brand-primary focus:border-brand-primary focus:outline-none focus:ring-2 focus:ring-brand-primary/50"
                ...
                <Button href="https://api.whatsapp.com/send?phone=5545999573497&text=Quero%20falar%20com%20a%20Cooperativa%20IBS" target="_blank" rel="noopener" variant="secondary">
        ...
        <section className="section">
          <div className="grid gap-8 rounded-3xl bg-brand-dark px-8 py-10 text-white shadow-soft md:grid-cols-[1.1fr_0.9fr] md:items-center">
            ...
            <div className="relative mx-auto flex h-64 w-64 items-center justify-center rounded-full bg-white/5 overflow-hidden">
              <Image 
